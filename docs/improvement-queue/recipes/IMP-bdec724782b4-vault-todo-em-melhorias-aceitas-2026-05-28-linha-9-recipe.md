...
# Recipe IMP-bdec724782b4 — Vault: TODO em 'Melhorias Aceitas — 2026-05-28' (linha 93)
...
Sinal encontrado pelo VaultScanner no segundo cérebro: "TODO: em 'Fluxo Automático e Versionamento' (linha 114)".

Origem: `60 - Daily/2026-05-28-improvements-accepted.md:93`. Considere transformar em story (ou marcar como resolvido).
...
60 - Daily/2026-05-28-improvements-accepted.md:93 — TODO: em 'Fluxo Automático e Versionamento' (linha 114)
...
1. Ler o brief original em `docs/improvement-queue/IMP-bdec724782b4.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-bdec724782b4`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-bdec724782b4] Vault: TODO em 'Melhorias Aceitas — 2026-05-28' (linha 93)"
   ```
...
- [ ] Commit subject contém `[IMP-bdec724782b4]`

## Notas relacionadas

- Brief original: [[IMP-bdec724782b4]]
