...
# Recipe IMP-c57645db4ac7 — Vault: TODO em 'ADR-003 — Bybit Testnet Readiness' (linha 84)
...
1. Ler o brief original em `docs/improvement-queue/IMP-c57645db4ac7.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-c57645db4ac7`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-c57645db4ac7] Vault: TODO em 'ADR-003 — Bybit Testnet Readiness' (linha 84)"
   ```
...
- [ ] Commit subject contém `[IMP-c57645db4ac7]`

## Notas relacionadas

- Brief original: [[IMP-c57645db4ac7]]
