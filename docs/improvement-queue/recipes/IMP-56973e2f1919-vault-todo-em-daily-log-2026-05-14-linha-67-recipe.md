...
# Recipe IMP-56973e2f1919 — Vault: TODO em 'Daily Log — 2026-05-14' (linha 67)
...
1. Ler o brief original em `docs/improvement-queue/IMP-56973e2f1919.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-56973e2f1919`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-56973e2f1919] Vault: TODO em 'Daily Log — 2026-05-14' (linha 67)"
   ```
...
- [ ] Commit subject contém `[IMP-56973e2f1919]`

## Notas relacionadas

- Brief original: [[IMP-56973e2f1919]]
