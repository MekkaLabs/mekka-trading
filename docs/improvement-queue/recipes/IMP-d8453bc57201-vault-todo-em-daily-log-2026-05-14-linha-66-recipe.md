...
# Recipe IMP-d8453bc57201 — Vault: TODO em 'Daily Log — 2026-05-14' (linha 66)
...
1. Ler o brief original em `docs/improvement-queue/IMP-d8453bc57201.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-d8453bc57201`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-d8453bc57201] Vault: TODO em 'Daily Log — 2026-05-14' (linha 66)"
   ```
...
- [ ] Commit subject contém `[IMP-d8453bc57201]`

## Notas relacionadas

- Brief original: [[IMP-d8453bc57201]]
