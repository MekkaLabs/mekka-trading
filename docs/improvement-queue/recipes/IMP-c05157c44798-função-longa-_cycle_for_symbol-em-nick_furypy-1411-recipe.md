...
# Recipe IMP-c05157c44798 — Função longa: _cycle_for_symbol() em nick_fury.py (1411 linhas)
...
1. Ler o brief original em `docs/improvement-queue/IMP-c05157c44798.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-c05157c44798`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-c05157c44798] Função longa: _cycle_for_symbol() em nick_fury.py (1411 linhas)"
   ```
...
- [ ] Commit subject contém `[IMP-c05157c44798]`

## Notas relacionadas

- Brief original: [[IMP-c05157c44798]]
