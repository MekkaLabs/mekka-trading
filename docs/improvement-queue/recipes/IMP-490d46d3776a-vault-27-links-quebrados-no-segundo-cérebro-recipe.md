...
# Recipe IMP-490d46d3776a — Vault: 27 link(s) quebrado(s) no segundo cérebro
...
1. Ler o brief original em `docs/improvement-queue/IMP-490d46d3776a.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-490d46d3776a`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-490d46d3776a] Vault: 27 link(s) quebrado(s) no segundo cérebro"
   ```
...
- [ ] Commit subject contém `[IMP-490d46d3776a]`

## Notas relacionadas

- Brief original: [[IMP-490d46d3776a]]
