...
# Recipe IMP-9ef1d8336067 — Refatorar nick_fury.py (2975 linhas)
...
1. Ler o brief original em `docs/improvement-queue/IMP-9ef1d8336067.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-9ef1d8336067`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-9ef1d8336067] Refatorar nick_fury.py (2975 linhas)"
   ```
...
- [ ] Commit subject contém `[IMP-9ef1d8336067]`

## Notas relacionadas

- Brief original: [[IMP-9ef1d8336067]]
