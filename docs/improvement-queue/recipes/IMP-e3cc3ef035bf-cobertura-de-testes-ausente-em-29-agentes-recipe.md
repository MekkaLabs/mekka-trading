...
area: backend
impact: MEDIUM
generated_at: 2026-06-01T20:55:16
auto_generated: true
---

# Recipe IMP-e3cc3ef035bf — Cobertura de testes ausente em 29 agente(s)
...
1. Ler o brief original em `docs/improvement-queue/IMP-e3cc3ef035bf.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-e3cc3ef035bf`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-e3cc3ef035bf] Cobertura de testes ausente em 29 agente(s)"
   ```
...
- [ ] Commit subject contém `[IMP-e3cc3ef035bf]`

## Notas relacionadas

- Brief original: [[IMP-e3cc3ef035bf]]
