...
# Recipe IMP-0e371fca2309 — Vault: 9 link(s) quebrado(s) no segundo cérebro
...
1. Ler o brief original em `docs/improvement-queue/IMP-0e371fca2309.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-0e371fca2309`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-0e371fca2309] Vault: 9 link(s) quebrado(s) no segundo cérebro"
   ```
...
- [ ] Commit subject contém `[IMP-0e371fca2309]`

## Notas relacionadas

- Brief original: [[IMP-0e371fca2309]]
