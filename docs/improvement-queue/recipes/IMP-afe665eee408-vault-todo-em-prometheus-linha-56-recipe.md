...
# Recipe IMP-afe665eee408 — Vault: TODO em 'Prometheus' (linha 56)
...
1. Ler o brief original em `docs/improvement-queue/IMP-afe665eee408.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-afe665eee408`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-afe665eee408] Vault: TODO em 'Prometheus' (linha 56)"
   ```
...
- [ ] Commit subject contém `[IMP-afe665eee408]`

## Notas relacionadas

- Brief original: [[IMP-afe665eee408]]
