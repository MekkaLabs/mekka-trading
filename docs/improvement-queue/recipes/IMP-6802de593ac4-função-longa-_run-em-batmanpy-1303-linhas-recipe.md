...
# Recipe IMP-6802de593ac4 — Função longa: _run() em batman.py (1303 linhas)
...
`_run` em `src/agents/batman.py` tem 1303 linhas (limite 120). Funções longas escondem complexidade e dificultam teste — extrair em helpers.
...
src/agents/batman.py: _run() = 1303 linhas (limite 120).
...
1. Ler o brief original em `docs/improvement-queue/IMP-6802de593ac4.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-6802de593ac4`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-6802de593ac4] Função longa: _run() em batman.py (1303 linhas)"
   ```
...
- [ ] Commit subject contém `[IMP-6802de593ac4]`

## Notas relacionadas

- Brief original: [[IMP-6802de593ac4]]
