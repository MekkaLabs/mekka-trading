...
# Recipe IMP-d0c71fdd07fd — Vault: TODO em 'Departamento de Melhoria Contínua' (linha 35)
...
1. Ler o brief original em `docs/improvement-queue/IMP-d0c71fdd07fd.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-d0c71fdd07fd`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-d0c71fdd07fd] Vault: TODO em 'Departamento de Melhoria Contínua' (linha 35)"
   ```
...
- [ ] Commit subject contém `[IMP-d0c71fdd07fd]`

## Notas relacionadas

- Brief original: [[IMP-d0c71fdd07fd]]
