...
# Recipe IMP-7ec05572c966 — Vault: TODO em 'Daily Log — 2026-05-15' (linha 49)
...
1. Ler o brief original em `docs/improvement-queue/IMP-7ec05572c966.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-7ec05572c966`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-7ec05572c966] Vault: TODO em 'Daily Log — 2026-05-15' (linha 49)"
   ```
...
- [ ] Commit subject contém `[IMP-7ec05572c966]`

## Notas relacionadas

- Brief original: [[IMP-7ec05572c966]]
