...
# Recipe IMP-0aba01fc3fdc — Refatorar src/models/market_data.py (861 linhas)
...
1. Ler o brief original em `docs/improvement-queue/IMP-0aba01fc3fdc.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-0aba01fc3fdc`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-0aba01fc3fdc] Refatorar src/models/market_data.py (861 linhas)"
   ```
...
- [ ] Commit subject contém `[IMP-0aba01fc3fdc]`

## Notas relacionadas

- Brief original: [[IMP-0aba01fc3fdc]]
