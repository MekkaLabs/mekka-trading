...
# Recipe IMP-9129a10c0d4a — Refatorar batman.py (1797 linhas)
...
1. Ler o brief original em `docs/improvement-queue/IMP-9129a10c0d4a.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-9129a10c0d4a`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-9129a10c0d4a] Refatorar batman.py (1797 linhas)"
   ```
...
- [ ] Commit subject contém `[IMP-9129a10c0d4a]`

## Notas relacionadas

- Brief original: [[IMP-9129a10c0d4a]]
