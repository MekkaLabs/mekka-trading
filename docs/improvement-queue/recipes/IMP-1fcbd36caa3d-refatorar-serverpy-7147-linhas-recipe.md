...
# Recipe IMP-1fcbd36caa3d — Refatorar server.py (7147 linhas)
...
1. Ler o brief original em `docs/improvement-queue/IMP-1fcbd36caa3d.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-1fcbd36caa3d`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-1fcbd36caa3d] Refatorar server.py (7147 linhas)"
   ```
...
- [ ] Commit subject contém `[IMP-1fcbd36caa3d]`

## Notas relacionadas

- Brief original: [[IMP-1fcbd36caa3d]]
