...
# Recipe IMP-e075e87b6595 — Vault: TODO em 'Melhorias Aceitas — 2026-05-28' (linha 143)
...
1. Ler o brief original em `docs/improvement-queue/IMP-e075e87b6595.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-e075e87b6595`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-e075e87b6595] Vault: TODO em 'Melhorias Aceitas — 2026-05-28' (linha 143)"
   ```
...
- [ ] Commit subject contém `[IMP-e075e87b6595]`

## Notas relacionadas

- Brief original: [[IMP-e075e87b6595]]
