...
# Recipe IMP-72474e56d6f0 — Refatorar iron_man.py (2203 linhas)
...
1. Ler o brief original em `docs/improvement-queue/IMP-72474e56d6f0.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-72474e56d6f0`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-72474e56d6f0] Refatorar iron_man.py (2203 linhas)"
   ```
...
- [ ] Commit subject contém `[IMP-72474e56d6f0]`

## Notas relacionadas

- Brief original: [[IMP-72474e56d6f0]]
