...
# Recipe IMP-480e21e48ce7 — Vault: TODO em 'Runbook — Bybit Testnet Setup' (linha 35)
...
1. Ler o brief original em `docs/improvement-queue/IMP-480e21e48ce7.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-480e21e48ce7`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-480e21e48ce7] Vault: TODO em 'Runbook — Bybit Testnet Setup' (linha 35)"
   ```
...
- [ ] Commit subject contém `[IMP-480e21e48ce7]`

## Notas relacionadas

- Brief original: [[IMP-480e21e48ce7]]
