...
# Recipe IMP-fefe0045d3d3 — Frontend: refatorar app.js (8538 linhas)
...
1. Ler o brief original em `docs/improvement-queue/IMP-fefe0045d3d3.md`.
2. Confirmar escopo e blast radius (≤5 arquivos, ≤500 linhas recomendado).
3. Criar branch local: `git checkout -b imp/IMP-fefe0045d3d3`
...
6. Commit com tag IMP no subject:
   ```bash
   git commit -m "[IMP-fefe0045d3d3] Frontend: refatorar app.js (8538 linhas)"
   ```
...
- [ ] Commit subject contém `[IMP-fefe0045d3d3]`

## Notas relacionadas

- Brief original: [[IMP-fefe0045d3d3]]
