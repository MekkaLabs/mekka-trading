...
area: "backend"
priority: "P1"
created_at: "2026-05-21T19:12:53.048055+00:00"
---

# IMP-967df0643a4a — Refatorar server.py (6595 linhas)

## Title

Refatorar server.py (6595 linhas)
...
`src/dashboard/server.py` tem 6595 linhas — acima do limite de 1500. Arquivos grandes concentram risco, dificultam revisão e testes. Quebrar em módulos coesos por responsabilidade.
...
src/dashboard/server.py: 6595 linhas (limite 1500, enorme ≥4000).
...
- [ ] PR aberto e vinculado a este rec_id (967df0643a4a) para aprovação do operador.
