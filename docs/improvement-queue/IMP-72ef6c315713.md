...
area: "backend"
priority: "P1"
created_at: "2026-05-25T15:19:15.971324+00:00"
---

# IMP-72ef6c315713 — Refatorar server.py (6623 linhas)

## Title

Refatorar server.py (6623 linhas)
...
`src/dashboard/server.py` tem 6623 linhas — acima do limite de 1500. Arquivos grandes concentram risco, dificultam revisão e testes. Quebrar em módulos coesos por responsabilidade.
...
src/dashboard/server.py: 6623 linhas (limite 1500, enorme ≥4000).
...
- [ ] PR aberto e vinculado a este rec_id (72ef6c315713) para aprovação do operador.
