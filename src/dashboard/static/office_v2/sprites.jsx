...
const AGENTS = [
  ...
  {
    // Mekka — Continuous-Improvement Commander. Green tech-armor + glowing
    // lime lens eyes (brand logo). NOTE: keep in sync with /static/agents-sprites.js.
    id: "mekka",
    name: "Mekka",
  ...
  {
    // Galactus — Premortem Specialist / Devourer of Ideas. Cosmic purple
    // armor + helmet-crown. NOTE: keep in sync with /static/agents-sprites.js.
    id: "galactus",
    name: "Galactus",
