...
const AGENTS = [
  ...
  },
  {
    ...
    // hair + green Marvel suit, with a fiery telekinetic aura (cape overlay
    // in gold/red). Read-only: curates the vault + long-term memory, never
    // trades. Placed in L4 alongside Beast.
    id: "jeangrey",
    name: "JeanGrey",
    role: "Memory Master",
    layer: "L4",
    color: "#f5c542",  // phoenix gold
